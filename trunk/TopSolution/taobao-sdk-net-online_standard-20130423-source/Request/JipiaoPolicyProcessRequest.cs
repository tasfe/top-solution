...
namespace Top.Api.Request
{
    ...
    public class JipiaoPolicyProcessRequest : ITopRequest<JipiaoPolicyProcessResponse>
    {
        ...
        /// <summary>
        /// 扩展字段：      "rfc" 对应值 1:不退不改不签,2:收费退改签（退、改、签中任意一个收费即为收费退改签）3:免费退改签      "ipt" 对应值 1:“打印价格等于销售价”,2:“不提供行程单”,3:“打印价格高于销售价”,4:“打印价格低于销售价”,例如：rfc=1;ipt=1      "fdtod"对应值起飞时间“0000”为0时0分       "ldtod"对应值：到达时间“2359”为23时59分
        /// </summary>
