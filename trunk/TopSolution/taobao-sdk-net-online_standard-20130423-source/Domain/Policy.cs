...
namespace Top.Api.Domain
{
    ...
    public class Policy : TopObject
    {
        ...
        /// <summary>
        /// 扩展字段,json格式：   "rfc" 对应值: 1.不退不改不签,2.收费退改签（退、改、签中任意一个收费即为收费退改签）,3.免费退改签 ；  "ipt" 对应值 :1.“打印价格等于销售价”,2.“不提供行程单”,3.“打印价格高于销售价”,4.“打印价格低于销售价”,对于客人来说:提供报销凭证包括(1,3),不提供报销凭证包括(2,4)；  "fdtod"对应值：起飞时间“0000”为0时0分  "ldtod"对应值：到达时间“2359”为23时59分
        /// </summary>
